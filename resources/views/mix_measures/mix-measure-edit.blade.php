    ...
    <div class="container-fluid">
        ...
        <div class="mt-3">
            <div class="card shadow p-4">
                <form action="{{ route('mix_measure_update_action') }}" method="POST" id="mixing_measure_form"
                    class="cta_btn_form">
                    @csrf
                    <input type="hidden" name="daily_measure_id"
                        value="{{ $find_blending_measure_by_id->daily_measure_id }}">
                    <input type="hidden" name="mixing_item_id" value="{{ $find_blending_measure_by_id->mixing_item_id }}">
                            ...
                            <div class="col-4">
                                <div class="input-group ">
                                    ...
                                    <input type="number" maxlength="7" class="form-control p-2 border border-dark"
                                        id="temperature" name="temperature_1"
                                        value="{{ $find_blending_measure_by_id->temperature_1 }}">
                                </div>
                            ...
                            <div class="col-4">
                                <div class="input-group ">
                                    ...
                                    <input type="number" maxlength="7" class="form-control p-2 border border-dark"
                                        ...
                                        value="{{ $find_blending_measure_by_id->temperature_2 }}">
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="input-group ">
                                            ...
                                            <input type="number" maxlength="7"
                                                ...
                                                name="weight_1" value="{{ $find_blending_measure_by_id->weight_1 }}">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="input-group ">
                                            ...
                                            <input type="number" maxlength="7"
                                                ...
                                                name="weight_2" value="{{ $find_blending_measure_by_id->weight_2 }}">
                                        </div>
                                    </div>
                                    <div class="col-6 mt-4">
                                        <div class="input-group ">
                                            ...
                                            <input type="number" maxlength="7"
                                                class="form-control p-2 border border-dark" id="temperature"
                                                name="weight_3" value="{{ $find_blending_measure_by_id->weight_3 }}">
                                        </div>
                                    </div>
                                    <div class="col-6 mt-4">
                                        <div class="input-group ">
                                            ...
                                            <input type="number" maxlength="7"
                                                class="form-control p-2 border border-dark" id="temperature"
                                                name="weight_4" value="{{ $find_blending_measure_by_id->weight_4 }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <input type="text" class="form-control p-2 border border-dark" id="table"
                                    name="table" value="{{ $find_blending_measure_by_id->table_line }}">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <input type="text" class="form-control p-2 border border-dark" id="scale"
                                    name="scale" value="{{ $find_blending_measure_by_id->scale }}">
                            </div>
                    ...
                    <div class="float-start mt-5">
                        <a href="{{ route('mix_log', Crypt::encrypt($find_blending_measure_by_id->id)) }}" type="submit"
                            class="btn btn-outline-warning pt-2 pb-2"><i class="bi bi-eye pe-1"></i> View
                            log</a>
                    </div>
                    <div class="float-end mt-5">
                        <a href="{{ route('mix_list', [Crypt::encrypt(6), Crypt::encrypt($find_blending_measure_by_id->daily_measure_id)]) }}"
                            class="btn btn-outline-secondary pt-2 pb-2 ps-5 pe-5 me-4">Cancel</a>
                        <a href="{{ route('unverified_measure_item', [$find_blending_measure_by_id->id, 'mixing_measures']) }}"
