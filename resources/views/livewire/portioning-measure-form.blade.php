                ...
                <div class="accordion-item mb-3">
                    <h2 class="accordion-header" id="heading-{{ $orderDetailId }}">
                        <button
                            ...
                            data-bs-target="#collapse-{{ $orderDetailId }}"
                            aria-expanded="true"
                            aria-controls="collapse-{{ $orderDetailId }}">
                            {{ $firstRow['order_detail']['component_details'] }}
                        </button>
                    </h2>
                    <div id="collapse-{{ $orderDetailId }}" class="accordion-collapse collapse {{ $isFirst ? 'show' : '' }}" aria-labelledby="heading-{{ $orderDetailId }}" data-bs-parent="#accordionExample">
                                ...
                                <div class="table-scroll-wrapper">
                                    <table class="{{ $is_ended ? 'component-table disabled' : 'component-table' }}">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><span class="letter-badge">{{ $log['order_detail']['letter'] }}</span></td>
                                                ...
                                                <td>{{ !empty($log['start_time']) ? date('H:i A', strtotime($log['start_time'])) : '—' }}</td>
                                                <td>{{ !empty($log['end_time']) ? date('H:i A', strtotime($log['end_time'])) : '—' }}</td>
                                                <td><span class="qty-value">{{ $log['order_detail']['quantity'] }}</span></td>
                                                <td class="text-center">
                                                    <button wire:click="measurementFormOpen({{ $log['id'] }})" class="action-btn">
