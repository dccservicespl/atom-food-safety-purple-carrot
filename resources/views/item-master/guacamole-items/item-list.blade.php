            ...
            <div class="row">
                <div class="col-6">
                    <div class="card_title_color text-dark text-start ps-2" style="font-size: 22px">
                        <strong>Guacamole Item Master</strong>
                    </div>
                </div>

                <div class="col-6 text-end pt-3">
                    <a href="{{ route('guacamole_add_items') }}"
                                ...
                                @if ($get_all_item->isNotEmpty())
                                    @foreach ($get_all_item as $get_the_guacamole_items_data)
                                        <tr>
                                            ...
                                            <td>{{ $get_the_guacamole_items_data->weight }} oz</td>
                                            ...
                                            @endif
                                            <td>
                                                <a href="{{ route('guacamole_edit_items', Crypt::encrypt($get_the_guacamole_items_data->id)) }}"
