            ...
            <div class="row">
                <div class="col-6">
                    <div class="card_title_color text-dark text-start ps-2" style="font-size: 22px">
                        <strong>Add Blending Item</strong>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="table-container">
                        <form action="{{ route('add_blending_item_action') }}" method="POST" id="add_blending_item_form">
                            @csrf
                            <div class="row">
                                <div class="col-3 p-3">
                                ...
                                <div class="col-3 p-3">
                                    ...
                                    <input type="text" name="ph_min" class="form-control p-2 border border-dark"
                                        required maxlength="5">
                                </div>
                                <div class="col-3 p-3">
                                    <label for="item_name"> Maximum pH <span class="text-danger">*</span>
                                    </label>
                                    <input type="text" name="ph_max" class="form-control p-2 border border-dark"
                                        required maxlength="5">
                                </div>
                                <div class="col-3 p-3">
                                    <label for="item_name"> Temperature <span class="text-danger">*</span> </label>
                                    <input type="text" name="temperature" class="form-control p-2 border border-dark"
                                        required>
                                </div>
                                <div class="col-3 p-3">
                                    <label for="item_name"> Weight <span class="text-danger">*</span> </label>
                                    <input type="text" name="weight" class="form-control p-2 border border-dark"
                                        required>
                                </div>
                                <div class="col-9 p-5 float-end text-end">
