            ...
            <div class="row">
                <div class="col-6">
                    <div class="card_title_color text-dark text-start ps-2" style="font-size: 22px">
                        <strong>Edit Blending Item</strong>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="table-container">
                        <form action="{{ route('edit_blending_item_action', $get_item->id) }}" method="POST"
                            id="add_blending_item_form">
                            @csrf
                            <div class="row">
                                <div class="col-3 p-3">
                                ...
                                <div class="col-3 p-3">
                                    ...
                                    <input type="text" name="weight" value="{{ $get_item->weight }}" class="form-control p-2 border border-dark"
                                        required>
                                </div>
                                <div class="col-3 p-3">
