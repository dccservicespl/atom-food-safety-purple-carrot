...
<x-breadcrumb-component :get_route="$get_route" :back_route="$get_route" page_title="Day Details" :breadcrumb_links="[['name' => 'Home', 'route' => $get_route], ['name' => '3.2 Week', 'route' => route('portioning_measure_dashboard')], ['name' => 'Day Details', 'route' =>'']]"/>
        ...
        <!-- Production Schedule:name -->
         ...
         <div class="d-flex align-items-center justify-content-between gap-3">
             <div class="d-flex gap-3">
              ...
              <button type="button" class="btn_2" data-bs-toggle="modal" data-bs-target="#measurementModal"> <span><i class="bi bi-clock"></i></span> Start Time</button>
...
<section class="mb-5">
  ...
  <div class="table-card">
    <div class="table-scroll-wrapper">
      {{-- use class disabled to table inactive  --}}
      <table class="component-table disabled">
        ...
        <tbody>
          {{-- add in row(tr) class completed or process --}}
          <tr>
...
<section class="mb-5">
  <div class="container">
    ...
    <div class="progress-label">Production<br>Completed</div>
        ...
        {{-- <div class="progress-card" style="--progress: {{ $progress }}"> --}}
   </div>
      </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="d-flex flex-wrap gap-2 mb-2">
          <div class="radio-pill"><input type="radio" name="table" id="t1" value="1"><label for="t1"><span class="radio-circle"><span></span></span>1</label></div>
          <div class="radio-pill"><input type="radio" name="table" id="t2" value="2"><label for="t2"><span class="radio-circle"><span></span></span>2</label></div>
          <div class="radio-pill"><input type="radio" name="table" id="t3" value="3"><label for="t3"><span class="radio-circle"><span></span></span>3</label></div>
          <div class="radio-pill"><input type="radio" name="table" id="t4" value="4"><label for="t4"><span class="radio-circle"><span></span></span>4</label></div>
          <div class="radio-pill"><input type="radio" name="table" id="t5" value="5"><label for="t5"><span class="radio-circle"><span></span></span>5</label></div>
          <div class="radio-pill"><input type="radio" name="table" id="t6" value="6"><label for="t6"><span class="radio-circle"><span></span></span>6</label></div>
          <div class="radio-pill"><input type="radio" name="table" id="t7" value="7"><label for="t7"><span class="radio-circle"><span></span></span>7</label></div>
          <div class="radio-pill"><input type="radio" name="table" id="t8" value="8"><label for="t8"><span class="radio-circle"><span></span></span>8</label></div>
        </div>
        ...
        <div class="d-flex gap-3 mb-2">
          <div class="radio-pill"><input type="radio" name="preop" id="yes" value="yes"><label for="yes"><span class="radio-circle"><span></span></span>Yes</label></div>
          <div class="radio-pill"><input type="radio" name="preop" id="no"  value="no" ><label for="no" ><span class="radio-circle"><span></span></span>No</label></div>
        </div>
