    ...
    <div class="page_card bg_white">
        <div class="row">
            ...
            <div class="col-4">
                ...
                <p class="text-center text-dark mb-0 font-weight-bold bold">
                    <strong>
                        {{ $all_blending_item_count->total_items - $all_blending_item_count->completed_status }}
                    </strong>
                </p>
            </div>
            <div class="col-4 text-center">
                ...
                <p class="text-center text-dark mb-0 font-weight-bold bold">
                    <strong> {{ $all_blending_item_count->completed_status }} </strong>
                </p>
            </div>
            @else
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" target="_blank" style="font-size: 16px; padding-bottom:20px;"
                                href="{{ route('download_mix_measure_pdf', Crypt::encrypt($get_the_date_details->id)) }}"><i
                                    class="far fa-file-pdf mix_color" style="margin-right: 10px;"></i> PDF</a>
                        </li>
                        <li><a class="dropdown-item" style="font-size: 16px;"
                                href="{{ route('download_mix_excel', $get_the_date_details->id) }}"><i
            ...
            <div class="col-12">
                <div class="table-container">
                    <table class="table measure_date_list">
                        <thead>
                            <tr style="background-color: #49C6E6 !important; color: #fff;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a
                                        href="{{ route('mixing_details', [Crypt::encrypt($get_the_blending_items_data->blending_id), $date_id]) }}">
