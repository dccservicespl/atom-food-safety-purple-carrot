    ...
    <div class="container-fluid">
        ...
        <div class="mt-3">
            <div class="card shadow p-4">
                <form action="{{ route('blending_details_action') }}" method="POST" id="blending_details_form"
                    class="cta_btn_form">
                    @csrf
                    <input type="hidden" name="blending_measure_id" value="{{ $date_id }}">
                    <input type="hidden" name="blending_item_id" value="{{ $item_id }}">
